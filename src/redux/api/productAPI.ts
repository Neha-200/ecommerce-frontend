...
export const productAPI = createApi({
    ...
    endpoints:(builder) => ({
        ...
        searchProducts: builder.query<SearchProductsResponse, 
...
export const { useLatestProductsQuery, useAllProductsQuery, useCategoriesQuery,
    useSearchProductsQuery, useProductDetailsQuery, useNewProductMutation, useUpdateProductMutation
